...
X = dataset.iloc[:, [3, 4]].values # using only the last 2 column data
...
wcss = [] # a list for adding wcss values of each cluster 
for i in range(1, 11):
    kmeans = KMeans(n_clusters = i, init = 'k-means++', random_state = 42)
    kmeans.fit(X)
    wcss.append(kmeans.inertia_) # this attribute calls for wcss value
...
# The plot shows that optimal value of wcss is 5 here
